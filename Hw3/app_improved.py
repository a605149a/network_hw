...
def login():
    ...
    if request.method == 'POST':
        if (username, password) in [('liu', '123'), ('yu', '123')]:
...
if __name__ == '__main__':
    #app.debug = True
    app.run('0.0.0.0', debug=True, port=5000, ssl_context=('C:\Python34\chapter11\server.crt', 'C:\Python34\chapter11\server.key'))
    #app.run()
